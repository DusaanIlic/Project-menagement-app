...
6. Na kraju jeste potrebno odaraditi migraciju odnosno postaviti početnu šemu baze podataka na osnvu entita koji smo definisali, sledeću liniju koda je potrebno napisati u Package Manager Console: Add-Migration InitialCreate. 